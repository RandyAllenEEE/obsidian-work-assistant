...
<div class="nav" class:is-mobile={isMobile}>
  <h3 class="title">
    <span
      class="month"
      on:click={(e) => onClickMonth && onClickMonth(e, displayedMonth)}
      on:keydown={(e) =>
        e.key === "Enter" && onClickMonth && onClickMonth(e, displayedMonth)}
      role="button"
      tabindex="0"
    >
    ...
    <span
      class="year"
      on:click={(e) => onClickYear && onClickYear(e, displayedMonth)}
      on:keydown={(e) =>
        e.key === "Enter" && onClickYear && onClickYear(e, displayedMonth)}
      role="button"
      tabindex="0"
    >
  ...
  <div class="right-nav">
    ...
    <div
      ...
      on:keydown={(e) => e.key === "Enter" && resetDisplayedMonth()}
      role="button"
      tabindex="0"
    >
      {todayDisplayStr}
