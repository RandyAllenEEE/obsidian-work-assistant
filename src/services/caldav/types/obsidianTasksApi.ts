/**
 * TypeScript definitions for obsidian-tasks plugin API (v1)
 * Based on: https://github.com/obsidian-tasks-group/obsidian-tasks
 */
...
/**
 * obsidian-tasks plugin interface
 * Access via: app.plugins.plugins['obsidian-tasks-plugin']
 */
