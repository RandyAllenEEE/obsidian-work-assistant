<script lang="ts">
  ...
  import type {
    ...
    PeriodicNotesCache,
  } from "src/periodic/cache";
  import type CalendarPlugin from "src/main";
  import type { MarkdownView } from "obsidian";
  import { onMount } from "svelte";
  import type { Granularity } from "src/periodic/types";
  import { getRelativeDate } from "src/periodic/utils";
...
{#if showComplication && periodicData}
  <div class="timeline-container">
    <div
      ...
      on:click={toggleCalendarVisibility}
      on:keydown={(e) => e.key === "Enter" && toggleCalendarVisibility()}
      role="button"
      tabindex="0"
    >
        ...
        {#each weekDays as weekDay}
          ...
          >
            ...
            <div
              ...
              on:keydown={(e) =>
                e.key === "Enter" && openPeriodicNoteInView("day", weekDay)}
              role="button"
              tabindex="0"
            >
              {weekDay.format("DD")}
