export default {
  ...
  "settings-word-count-shock-threshold-desc": "When a single word count change exceeds this threshold, it will be ignored to prevent abnormal data. Default: 1000.",
